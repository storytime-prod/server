...
def upgrade() -> None:
    ...
    sa.Column('title', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.ForeignKeyConstraint(['dest_id'], ['story.id'], ),
    sa.ForeignKeyConstraint(['src_id'], ['story.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_branchrequest_comment'), 'branchrequest', ['comment'], unique=False)
    op.create_index(op.f('ix_branchrequest_created_at'), 'branchrequest', ['created_at'], unique=False)
    op.create_index(op.f('ix_branchrequest_dest_id'), 'branchrequest', ['dest_id'], unique=False)
    op.create_index(op.f('ix_branchrequest_src_id'), 'branchrequest', ['src_id'], unique=False)
    op.create_index(op.f('ix_branchrequest_status'), 'branchrequest', ['status'], unique=False)
